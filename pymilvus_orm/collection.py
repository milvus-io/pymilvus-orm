...
class Collection:
    ...
    def description(self) -> str:
        ...
        <milvus.client.stub.Milvus object at 0x7f9a190ca898>
        >>> field = FieldSchema("int64", DataType.INT64, descrition="int64", is_primary=False)
        >>> schema = CollectionSchema(fields=[field], description="This is an example text description.")
        >>> collection = Collection(name="test_collection", schema=schema, _using="default")
        >>> collection.description
    ...
    def name(self) -> str:
        ...
        <milvus.client.stub.Milvus object at 0x7f9a190ca898>
        >>> field = FieldSchema("int64", DataType.INT64, descrition="int64", is_primary=False)
        >>> schema = CollectionSchema(fields=[field], description="This is an example collection name.")
        >>> collection = Collection(name="test_collection", schema=schema, _using="default")
        >>> collection.name
        'test_collection'
        """
    ...
    def num_entities(self) -> int:
        ...
        <milvus.client.stub.Milvus object at 0x7f9a190ca898>
        >>> field = FieldSchema("int64", DataType.INT64, descrition="int64", is_primary=False)
        >>> schema = CollectionSchema(fields=[field], description="Retrieves the number of entities in a collection.")
        >>> collection = Collection(name="test_collection", schema=schema)
        >>> collection.num_entities
        0
        >>> data = [[1,2,3,4]]
    ...
    def drop(self, **kwargs):
        ...
        :param kwargs:
            * *timeout* (``float``) -- An optional duration of time in seconds to allow for the RPC. If timeout
    ...
    def search(self, data, anns_field, param, limit, expression, partition_names=None,
        ...
        :param kwargs:
            ...
            * *_callback* (``function``) --
              The callback function which is invoked after server response successfully. It functions
              only if _async is set to True.
